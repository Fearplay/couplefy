...
class AppColors{
  ...
  static const Color primaryContainerLight = Color(0xFFF3E5F5);
  //   static const Color primaryContainerLight = Color(0xFFDDA0DD);
  static Color secondaryContainerLight = Colors.grey.shade200; //TextField fillColor
  ...
  static const Color iconColorLight = Color(0xFF009688); //Color(0xFF5C6BC0)
  static const Color elevatedButtonColorLight = Color(0xFF5C6BC0); //Color(0xFF5C6BC0)
  static const Color bottomNavigationColorLight = Color(0xFF8E24AA); //Color(0xFF5C6BC0)
  ...
  static const Color primaryContainerDark = Color(0xFF1E1E2F);
  static const Color secondaryContainerDark = Color(0xFF1E1E2F);//TextField fillColor
  ...
  static const Color unselectedItemColorDark = Colors.white;
    static const Color iconColorDark = Color(0xFFF06292);
      static const Color elevatedButtonColorDark = Color(0xFFC2185B); //Color(0xFF5C6BC0)
      static const Color bottomNavigationColorDark = Color(0xFF303F9F); //Color(0xFF5C6BC0)
  ...
  static const Color firstHomepageCardColorLight = Color(0xFFE6E6FA);
  static const Color secondHomepageCardColorLight = Color(0xFFDDA0DD);
