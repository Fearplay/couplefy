...
class DaysRow extends StatelessWidget {
  /// Creates an instance of [DaysRow].
  ///
  ///   Parameters:
  /// - [dayEntryModel]: The name day model as [List].
  const DaysRow(this.dayEntryModel, this.savedLanguage, {super.key});
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<bool>(
        ...
        builder: (context, globalHolidays, _) {
          // If user choose to show "global holidays" then this will show up
          if (globalHolidays) {
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            dayEntryModel.globalDay![savedLanguage].toString(),
          ...
          // If user choose to not show "global holidays" then this will show up
          else {
            // If the day is current day. Then this happen:
            if (DatePickerUtils.todayDate.day == dayEntryModel.date.day && DatePickerUtils.todayDate.month == dayEntryModel.date.month) {
              return Container(
